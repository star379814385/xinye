...
if weight_path is None:
    weight_path = glob.glob("/media/gdut502/139e9283-5fa3-498b-ba3d-0272a299eeeb/wqr/xinye/xinye2021/"
                            "model_files/retrieval/swin_b224/model/best*.pth".format(model_name))
...
train_data = None
rewrite_train_data_features = True
