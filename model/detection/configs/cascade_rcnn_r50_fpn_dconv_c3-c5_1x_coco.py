...
log_level = 'INFO'
load_from = "/media/gdut502/139e9283-5fa3-498b-ba3d-0272a299eeeb/lrh/pytorch_pretrain/cascade_rcnn_r50_fpn_dconv_c3-c5_1x_coco_20200130-2f1fca44.pth"
resume_from = None
workflow = [('train', 1)]
work_dir = './work_dir/cascade_rcnn_r50_fpn_dconv_c3-c5_1x_coco_Focaloss'
gpu_ids = range(0, 2)
