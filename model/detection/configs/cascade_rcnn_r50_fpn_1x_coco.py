model = dict(
    ...
    test_cfg=dict(
        rpn=dict(
            ...
            min_bbox_size=0),
        rcnn=dict(
            score_thr=0.05, nms=dict(type="soft_nms", iou_threshold=0.5, min_score=0.001), max_per_img=100)
        )
        # rcnn=dict(
        #     score_thr=0.05,
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + "train/train_object.json",
...
log_level = 'INFO'
load_from = "/media/gdut502/139e9283-5fa3-498b-ba3d-0272a299eeeb/lrh/pytorch_pretrain/cascade_rcnn_r50_fpn_1x_coco_20200316-3dc56deb.pth"
resume_from = None
workflow = [('train', 1)]
work_dir = './work_dir/cascade_rcnn_r50_fpn_1x_coco_a'
gpu_ids = range(0, 2)
