...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=data_root + "train/train_ab_all.json",
...
log_level = 'INFO'
load_from = "/media/gdut502/139e9283-5fa3-498b-ba3d-0272a299eeeb/lrh/pytorch_pretrain/cascade_mask_rcnn_swin_small_patch4_window7.pth"
resume_from = None
workflow = [('train', 1)]
# fp16 = None
work_dir = './work_dir/cascade_mask_rcnn_swin_small_patch4_window7_mstrain_480-800_giou_4conv1f_adamw_3x_coco'
gpu_ids = range(0, 2)
