...
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = "/home/rr/Desktop/lrh/code/xinye2021/model_files/pretrained_model/cascade_mask_rcnn_swin_base_patch4_window7.pth"
# load_from = None
resume_from = None
workflow = [('train', 1)]
# fp16 = None
work_dir = './work_dir/cascade_mask_rcnn_swin_small_patch4_window7_mstrain_480-800_giou_4conv1f_adamw_3x_coco2'
gpu_ids = range(0, 2)